...
public class Tabla {
   ...
   */
   ...
   /**
    * Muestra la eficacia (con palabras) de un pokemon con dos tipos a un pokemon con uno
    *
    * @param tipo1Atacante
    * @param tipo2Atacante
    * @param tipoOponente
   ...
   public static void mostrarEficaciaTipos(int tipo1Atacante, int tipo2Atacante, int tipoOponente) {
       //multiplico las efectivadades
       double efectividad = Tabla.efectividadesPokemon[tipo1Atacante][tipoOponente] * Tabla.efectividadesPokemon[tipo2Atacante][tipoOponente];
       System.out.println(efectividad);
       System.out.println(mostrarEficacia(efectividad));
   }
