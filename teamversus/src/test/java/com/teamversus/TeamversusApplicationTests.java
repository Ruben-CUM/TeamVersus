...
class TeamversusApplicationTests {
	...
	public void testInicial() {
		...
		Pokemon venusaur = new Pokemon("Venusaur", "PLANTA", "VENENO", "/images/venusaur.gif",
				"/images/venusaur_back.gif");
		Pokemon charizard = new Pokemon("Charizard", "FUEGO", "VOLADOR", "/images/charizard.gif",
				"/images/charizard_back.gif");
		Pokemon blastoise = new Pokemon("Blastoise", "AGUA", null, "/images/blastoise.gif",
				"/images/blastoise_back.gif");
		Pokemon pidgeot = new Pokemon("Pidgeot", "NORMAL", "VOLADOR", "/images/pidgeot.gif",
				"/images/pidgeot_back.gif");
		...
		Pokemon sandslash = new Pokemon("Sandslash", "TIERRA", null, "/images/sandslash.gif",
				"/images/sandslash_back.gif");
		Pokemon nidoqueen = new Pokemon("Nidoqueen", "VENENO", "TIERRA", "/images/nidoqueen.gif",
				"/images/nidoqueen_back.gif");
		Pokemon nidoking = new Pokemon("Nidoking", "VENENO", "TIERRA", "/images/nidoking.gif",
				"/images/nidoking_back.gif");
		Pokemon clefable = new Pokemon("Clefable", "HADA", null, "/images/clefable.gif", "/images/clefable_back.gif");
		Pokemon ninetales = new Pokemon("Ninetales", "FUEGO", null, "/images/ninetales.gif",
				"/images/ninetales_back.gif");
		Pokemon wigglytuff = new Pokemon("Wigglytuff", "NORMAL", "HADA", "/images/wigglytuff.gif",
				"/images/wigglytuff_back.gif");
		Pokemon vileplume = new Pokemon("Vileplume", "PLANTA", "VENENO", "/images/vileplume.gif",
				"/images/vileplume_back.gif");
		Pokemon dugtrio = new Pokemon("Dugtrio", "TIERRA", null, "/images/dugtrio.gif", "/images/dugtrio_back.gif");
		Pokemon venomoth = new Pokemon("Venomoth", "BICHO", "VENENO", "/images/venomoth.gif",
				"/images/venomoth_back.gif");
		Pokemon muk = new Pokemon("Muk", "VENENO", null, "/images/muk.gif", "/images/muk_back.gif");
		Pokemon cloyster = new Pokemon("Cloyster", "AGUA", "HIELO", "/images/cloyster.gif",
				"/images/cloyster_back.gif");
		...
		Pokemon magneton = new Pokemon("Magneton", "ELÉCTRICO", "ACERO", "/images/magneton.gif",
				"/images/magneton_back.gif");
		Pokemon dewgong = new Pokemon("Dewgong", "AGUA", "HIELO", "/images/dewgong.gif", "/images/dewgong_back.gif");
		Pokemon gyarados = new Pokemon("Gyarados", "AGUA", "VOLADOR", "/images/gyarados.gif",
				"/images/gyarados_back.gif");
		...
		Pokemon articuno = new Pokemon("Articuno", "HIELO", "VOLADOR", "/images/articuno.gif",
				"/images/articuno_back.gif");
		...
		Pokemon dragonite = new Pokemon("Dragonite", "DRAGÓN", "VOLADOR", "/images/dragonite.gif",
				"/images/dragonite_back.gif");
